...
/**
 * Servlet implementation class EditStaffFormServlet
 */

@WebServlet(name = "EditStaffFormServlet", urlPatterns = "/EditStaffFormServlet")
public class EditStaffFormServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EditStaffFormServlet() {
        super();
    ...
    protected void doGet(final HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			List<String> roleList = service.getStaffRoles();
			if(roleList != null) {
