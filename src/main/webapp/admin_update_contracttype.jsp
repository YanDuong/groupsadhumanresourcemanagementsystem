...
<div class="container col-md-5">
    <div class="card">
        <div class="card-body">
            <form action="UpdateContractTypeServlet" method="post" id="updateprofile" enctype="multipart/form-data" >                   
            ...
            <input type="file" class="form-control" name="directory" accept=".doc, .docx" value="<c:out value='${type.fileName}' />" >
          </div>			                                                                                      
				<div class="form-group">
                           <div class="col-xs-12">
                                <br>
                              	<button type="submit" class="btn btn-outline-success" onclick="validate()">Save</button>
                              	 <button class="btn btn-danger" onclick="window.location.href='/ManageContractTypeServlet'">Cancel</button>
                            </div>
                      </div>
                    	</form>	
                    	</div>	
